...
gallery/city-selector/1.0/domestic
gallery/city-selector/1.0/index
...
* @version 1.0
*/
KISSY.add('gallery/city-selector/1.0/index',function(S,Node,Event,Richbase,Overlay,Xtpl,DomesticData){
	'use strict';
...
},{requires:['node','event','rich-base','overlay','xtemplate','./domestic','./assets/index.css']});
